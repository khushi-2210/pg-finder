        ...
        <div className="px-6 md:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <a href="/" className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-md bg-white/90 flex items-center justify-center shadow-sm overflow-hidden">
                <img
                  src="/logo.png"
                  alt="PGFinder Logo"
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href="/signup"
                className="hidden md:inline-flex items-center px-4 py-2 rounded-full bg-yellow-400 hover:bg-yellow-300 text-black font-semibold shadow"
              >
                Signup
              </a>
